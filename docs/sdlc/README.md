# AmioChat — SDLC Tracker

This folder tracks deliverables across the software development lifecycle for AmioChat.
...
1. Complete and sign off each phase before starting the next.
2. Record decisions in the phase document (or linked ADRs in Phase 2+).
3. Update the **Status** column here as phases move forward.
